...
public class HourlyOil implements HYIPInterface {

	private static final String NAME="HourlyOil";
	private String baseUrl = "https://hourlyoil.com";
	...
	private Logger log = Logger.getLogger("FEERS");
	...
	public double getAmount() {
		...
		if (isLogged()) {
			...
			if (check_OK(pg)) {
				...
				List<HtmlElement> trs = hes.findAll("tr[bgcolor]");
				for (HtmlElement e : trs) {
					String attr = e.getAttribute("bgcolor");
					if (attr.equalsIgnoreCase("#D0E3F5")) {
